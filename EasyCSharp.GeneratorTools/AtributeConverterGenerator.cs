...
public partial class AtributeConverterGenerator : GeneratorBase<ClassAttributeSyntaxReceiver>
{
    ...
    protected override void OnExecute(GeneratorExecutionContext context, ClassAttributeSyntaxReceiver SyntaxReceiver)
    {
        ...
        var ITypeParameterSymbolSymbol = context.Compilation.GetTypeByMetadataName(typeof(ITypeParameterSymbol).FullName);
    ...
    static IEnumerable<string> ProcessAttributes(ImmutableArray<AttributeData> AttributeData, ISymbol AddAttributeSymbol, ISymbol TypeSymbol, INamedTypeSymbol INamedTypeSymbolSymbol, ISymbol AttributeSymbol, ITypeSymbol ITypeParameterSymbolSymbol)
    {
        foreach (var attribute in AttributeData)
        {
            ...
            public partial struct {{TypeWrapper}} {
                ...
                {{
                    (
                        ...
                        /// </summary>
                        public {{ITypeParameterSymbolSymbol}} {{typeparameters.Name}} { get; set; }
                        """
                ...
                {{(
                    ...
                    (
                        ...
                        select
                            ...
                            result.{TypeParameters[i].Name} = attributeData.AttributeClass.TypeParameters[{i}];
                            """
                    ).JoinDoubleNewLine().IndentWOF(1)
                )}}
